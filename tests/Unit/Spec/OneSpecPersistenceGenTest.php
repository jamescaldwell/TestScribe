...
class OneSpecPersistenceGenTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_encodeOneSpec()
    {
        ...
        /** @var \Box\TestScribe\Spec\OneSpec $mockOneSpec1 */
        $mockOneSpec1 = $this->shmock(
        ...
        $executionResult = $objectUnderTest->encodeOneSpec($mockOneSpec1);
    ...
    public function test_loadOneSpec()
    {
        ...
        $executionResult = $objectUnderTest->loadOneSpec(['name' => 'test_name', 'result' => 1]);
